...
public class CoffeeMaker {
	...
	public boolean addRecipe(Recipe r) {
        ...
        canAddRecipe = checkDuplicateRecipe(r, canAddRecipe);
	...
	private boolean checkDuplicateRecipe(Recipe r, boolean canAddRecipe) {
    ...
    public int makeCoffee(Recipe r, int amtPaid)   {
        ...
        if(canMakeCoffee) {
	        inventory.setCoffee(inventory.getCoffee() - r.getAmtCoffee());  //coffee - recipe.amtCoffee instead of coffee + recipe.amtCoffee
